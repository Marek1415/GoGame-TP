...
public class PointsPanel extends JPanel {
	...
	public PointsPanel() {
		...
		//images
		redOFF = getIcon("src/main/resources/images/redOFF.png");
		redON = getIcon("src/main/resources/images/redON.png");
		greenOFF = getIcon("src/main/resources/images/greenOFF.png");
		greenON = getIcon("src/main/resources/images/greenON.png");
